...
Provides: golang-1.17-devel-static = %{epoch}:%{version}-%{release}
...
ln -fs %{_libdir}/go-1.17/bin/go %{buildroot}%{_bindir}/go
ln -fs %{_libdir}/go-1.17/bin/gofmt %{buildroot}%{_bindir}/gofmt
